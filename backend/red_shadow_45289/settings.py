"""
Django settings for red_shadow_45289 project.
...
ROOT_URLCONF = 'red_shadow_45289.urls'
...
WSGI_APPLICATION = 'red_shadow_45289.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "red_shadow_45289 API",
    "DESCRIPTION": "API documentation for red_shadow_45289 App",
    "VERSION": "v1",
}
